...
public class NBTModifier
{
    ...
    private static final Method SET_STRING = getMethodSafely(getNmsClass("NBTTagCompound"), "setString", String.class, String.class);
    private static final Method GET_STRING = getMethodSafely(getNmsClass("NBTTagCompound"), "getString", String.class);
    private static final Method REMOVE_TAG = getMethodSafely(getNmsClass("NBTTagCompound"), "remove", String.class);
